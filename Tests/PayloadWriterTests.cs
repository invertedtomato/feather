...
namespace InvertedTomato.IO.Feather.Tests {
	...
	public class PayloadWriterTests {
		...
		public void AppendTimeSpan() {
			var payload = new PayloadWriter(0x00);
			payload.AppendToSeconds(TimeSpan.FromSeconds(30));
		...
		public void AppendNullableTimeSpan() {
			...
			payload.AppendNullableToSeconds(timeSpan);
		...
		public void AppendBoolean() {
			...
			Assert.AreEqual("00-01", BitConverter.ToString(payload.ToByteArray()));
		}
